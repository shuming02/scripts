...
function create_one()
{
	...
	--data '{"ignoreResourceCheck":"test", "skipLicenseCheck":true, "appkey": "com.sankuai.inf.hulk.demo", "idc": "'$idc_name'", "env": "dev","num": 1,"cpu": 4,"mem": 4096,"hd": 200,"cluster": "k8s_kernel_qa"  ,"additional":{"requireAffinities":[{"key":"kubernetes.io/hostname","inValues":["'$1.mt'"],"operator":"IN"}] }}'`
