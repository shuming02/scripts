...
function create_one()
{
	...
	--data '{"ignoreResourceCheck":"test", "skipLicenseCheck":true, "appkey": "com.sankuai.inf.hulk.demo", "idc": "zf","env": "test","num": 1,"cpu": 4,"mem": 4096,"hd": 200,"clusterType": "default"  ,"additional":{     "dedicatedPool":["smartnic"],    "requireAffinities":[{"key":"kubernetes.io/hostname","inValues":["'$1.mt'"],"operator":"IN"}] }}'`
